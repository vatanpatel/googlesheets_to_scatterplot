...
setup(
    ...
    version='0.0.7',                                                                            # We define the version. We update this everytime we make a change
    description='We can create plots directly from Google Sheets',                              # We define the short discription
    long_description= long_description, # + '\n\n' + open('CHANGELOG.txt').read(),                 # We define the long distribution by adding long_discription variable and add our CHANGELOG to it
